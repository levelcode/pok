...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        #gente{
            background-image: url(img/gente.png);
            width: 100%;
            height: 94px;
        }
        #logo{
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <h1>Cambia tu foto de perfil  </br> en Facebook y WhatsApp <br>¡ Y actívate por el cambio !</h1>
            <input type="hidden" id="fb-name" name="fb-name">
                <p>Escribe tu Nombre: <input type="text" id="texto1"> (Max 10 Carácteres)</p>
                </br>
            ...
            <div id="botonera">
                ...
                <div id="share_l" class="boton"></div>
                <a id="download" target="_blank" class="boton" download="ImageName" title="ImageName">Volver a Descargar</a>
            </div>
