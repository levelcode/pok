<div class="content_facebook_connect" style="top: calc(86% - 62px);">
...
<div class="content_ingresar" style="display:none;">
	<p>Si usted es mayor de edad, ingrese su fecha de nacimiento.</p>
	<div class="border_top"></div>
	<form action="">
		<div class="border_gradient">
			<input type="text" placeholder="DÍA" class="date">
		</div>
        <div class="border_gradient">
        	<input type="text" placeholder="MES" class="date">
        </div>
        <div class="border_gradient">
        	<input type="text" placeholder="AÑO" class="date">
        </div>
